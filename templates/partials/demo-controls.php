...
<div class="demo-controls" data-demo-controls="<?php echo esc_attr( $demo_control_id ); ?>">
    ...
    <button type="button" class="ghost-button" data-demo-shift="-60"><?php esc_html_e( '-1 Hour', 'traveler' ); ?></button>
    <button type="button" class="ghost-button" data-demo-shift="60"><?php esc_html_e( '+1 Hour', 'traveler' ); ?></button>
    <button type="button" class="ghost-button" data-demo-shift="-1440"><?php esc_html_e( 'Previous Day', 'traveler' ); ?></button>
    <button type="button" class="ghost-button" data-demo-shift="1440"><?php esc_html_e( 'Next Day', 'traveler' ); ?></button>
    <button type="button" class="ghost-button" data-demo-now><?php esc_html_e( 'Today', 'traveler' ); ?></button>
</div>
